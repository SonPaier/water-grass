        ...
        <section className="py-20 md:py-28 px-6 md:px-8 bg-surface-lowest">
          <div className="max-w-[900px] mx-auto">
            ...
            <figure className="bg-white p-8 md:p-12 border-l-4 border-brand">
              ...
              <blockquote className="text-zinc-700 font-body text-lg md:text-xl leading-relaxed italic mb-8">
                „Solidna firma, która dba o swoich klientów — również po
                wykonaniu systemu nawadniania. Jestem szczerze zadowolony ze
                współpracy. Polecam!"
              </blockquote>
              <figcaption className="flex items-center gap-5 pt-6 border-t border-zinc-100">
                <div className="relative w-20 h-12 shrink-0 bg-white">
                  <Image
                    src="/images/partners/7-dla-ogrodu.png"
                    alt="7 Dla Ogrodu — logo"
                    fill
                    sizes="80px"

...
export const realizations: Realization[] = [
  ...
  {
    slug: "castorama-rumia",
    name: "Castorama",
    city: "Rumia",
    category: "komercja",
    categoryLabel: "Retail",
    image: "/images/realizacje/castorama-rumia.jpg",
    alt: "System nawadniania — Castorama, Rumia",
    description:
      "Tereny zewnętrzne sklepu wielkopowierzchniowego. Solidna instalacja przemysłowa z łatwym dostępem serwisowym, dostosowana do dużego natężenia ruchu klientów.",
    highlights: [
      "Studzienki zaworowe jumbo z łatwym dostępem",
      "Kombinacja zraszaczy rotacyjnych i linii kroplujących",
      "Praca w godzinach poza otwarciem sklepu",
    ],
    scope: [
      "Pomiar terenów zewnętrznych (parking, zieleń otaczająca)",
      "Projekt z wytycznymi pracy poza godzinami otwarcia sklepu",
      "Magistrala PE 32 mm dla części głównej",
      "Studzienki zaworowe jumbo — łatwy dostęp serwisowy",
      "Solidne zraszacze rotacyjne odporne na intensywny ruch",
      "Linia kroplująca dla nasadzeń przy wejściach",
      "Sterownik z możliwością zdalnego dostępu",
      "Serwis gwarancyjny w cyklu sezonowym",
    ],
    specs: [
      { label: "Typ obiektu", value: "Sklep wielkopowierzchniowy" },
      { label: "Sterownik", value: "Hunter (zdalny dostęp)" },
      { label: "Studzienki", value: "Jumbo — łatwy dostęp serwisowy" },
      { label: "Praca", value: "Poza godzinami otwarcia" },
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "Kompleksowe nawadnianie osiedla deweloperskiego. Pełna dokumentacja CAD, harmonogram zgrany z odbiorami inwestycji, gwarancja wieloletnia dla wspólnoty mieszkaniowej.",
    highlights: [
      "Projekt techniczny z dokumentacją CAD",
      "Harmonogram zgrany z generalnym wykonawcą",
      "Gwarancja wieloletnia + serwis sezonowy",
    ],
    scope: [
      "Projekt techniczny z dokumentacją CAD dla generalnego wykonawcy",
    ...
    specs: [
      ...
      { label: "Dokumentacja", value: "Pełna CAD + powykonawcza" },
